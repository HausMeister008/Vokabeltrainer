...
class Select:
    ...
    def __init__(self):
        ...
        self.spruch = Label(self.main, text = random.choice(self.list_of_motivations), font = ("Arial", 11, "bold"), wraplength=500,fg='#0fffc3', bg='#0A303E')
        ...
        self.info = Label(self.main, text = "Gib hier ein, wie viele deiner alten Vokabeln ", bg = '#0A303E', fg='#2cab31', font = ("Arial", 12, "bold"))
        self.info.place(relx = 0.5, rely = 0.4, anchor = "n")
        self.info2 = Label(self.main, text = " im Verhältnis zu deinen aktuellen hinzugemischt werden sollen:", bg = '#0A303E', fg='#2cab31', font = ("Arial", 12, "bold"))
        self.info2.place(relx = 0.5, rely = 0.45, anchor = "n")
